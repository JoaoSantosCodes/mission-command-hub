    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-border bg-card p-5 shadow-2xl ring-1 ring-primary/10">
        <div className="flex items-start justify-between gap-2">
          <div>
            <p className="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Novo agente</p>
            ...
            <p className="mt-1 text-[11px] text-muted-foreground">
              ...
              <span className="font-mono text-foreground/90">.aiox-core/development/agents/</span> no teu aiox-core.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="mt-4 space-y-3">
          ...
          {idTrim && !ID_RE.test(idTrim) ? (
            <p className="text-[11px] text-destructive">
              Usa apenas letras, números, <span className="font-mono">.</span> <span className="font-mono">_</span>{" "}
              <span className="font-mono">-</span> (máx. 128 caracteres após o primeiro).
            </p>
          ) : null}
