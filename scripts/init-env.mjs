...
console.log(
  "[mission-agent] Criado .env a partir de .env.ready — edita MISSION_LLM_API_KEY (qualquer API compatível) ou OPENAI_API_KEY legado; opcional MISSION_LLM_BASE_URL / MISSION_LLM_MODEL / MISSION_LLM_VALIDATE=0."
);
console.log(
